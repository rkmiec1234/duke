...
inference(a,est = "mean", type = "ht", method = "theoretical", null = 15, alternative = "twosided" )
```

#Single Median Estimate Hypothesis Test
```{r}
a <- rnorm(15, mean = 14, sd = 3)
inference(a,est = "median", type = "ht", method = "simulation", null = 15, alternative = "twosided" )
```
...
#Anova 
```{r}
inference(y = df$Petal.Width,x = iris$Species, est = "mean", type = "ht",  method = "theoretical", alternative = "greater")
```
